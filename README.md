<div align="center">
    <a href="https://lato.cdev"><h1 align="center">Lato.dev</h1></a>
...
```sh-session
git clone https://github.com/nklato/lato.dev.git
cd lato.dev
```


Create a `.env` file similar to [`.env.example`](https://github.com/nklato/lato.dev/blob/main/.env.example).
